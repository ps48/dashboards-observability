...
// RESOLUTION_LOW targets ~50 data points (sparklines), RESOLUTION_MEDIUM targets ~250 (full charts)
export const RESOLUTION_LOW = 50; // sparklines (industry std: 30-50 for table cell sparklines)
