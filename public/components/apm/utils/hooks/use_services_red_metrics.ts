  ...
  useEffect(() => {
    ...
    const fetchBatchMetrics = async () => {
      ...
      try {
        ...
        console.log('[useServicesRedMetrics] Fetching batch metrics with queries:', {
          latencyQuery,
          throughputQuery,
          failureRatioQuery,
        });
        ...
        console.log('[useServicesRedMetrics] Batch responses received:', {
          latency: latencyResp,
          throughput: throughputResp,
          failureRatio: failureRatioResp,
        });
        ...
        console.log('[useServicesRedMetrics] Metrics map populated:', newMetricsMap);
